  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-7 sm:py-12">
      ...
      <div className="text-center mb-6 sm:mb-12">
        <span className="text-xs font-bold text-accent uppercase tracking-widest">{t("contact.eyebrow")}</span>
        <h1 className="text-2xl sm:text-4xl font-extrabold text-ink mt-2 mb-2 sm:mb-3">{t("contact.title")}</h1>
        <p className="text-ink-soft max-w-md mx-auto text-[13px] sm:text-sm leading-snug sm:leading-relaxed">
          {t("contact.subtitle")}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 sm:gap-8 mb-10 sm:mb-16">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-5">
            ...
            <ul className="grid grid-cols-2 gap-3 sm:grid-cols-1 sm:gap-4">
              {infoItems.map((item) => (
                <li key={item.label} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-ink-muted uppercase tracking-widest">{item.label}</p>
          ...
          <a
            ...
            className="flex items-center gap-3 bg-[#25D366] text-white rounded-card p-4 sm:p-5 font-bold hover:opacity-90 transition-opacity shadow-sm"
          >
          ...
          >
            ...
            <div>
              <p className="text-sm font-bold text-ink">{t("contact.avgResponseTime")}</p>
      ...
      <section>
        <div className="text-center mb-5 sm:mb-8">
          <span className="text-xs font-bold text-accent uppercase tracking-widest">{t("contact.quickAnswers")}</span>
          <h2 className="text-xl sm:text-2xl font-extrabold text-ink mt-2">{t("contact.faqTitle")}</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {faqs.map((faq) => (
            ...
            >
              ...
              <p className="text-sm text-ink-soft leading-relaxed pl-5">{faq.a}</p>
            </div>
          ))}
        </div>
      </section>
