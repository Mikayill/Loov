  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="space-y-6">
        {faqs.map((section) => (
          <div key={section.category} className="bg-white rounded-card border border-line overflow-hidden">
      ...
      <div className="mt-10 p-6 rounded-card text-center" style={{ background: "linear-gradient(135deg, #EAF2F0 0%, #E8EEF4 100%)" }}>
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 font-bold text-sm px-5 py-2.5 rounded-full border-2 border-line text-ink-soft hover:border-accent hover:text-accent transition-colors"
          >
