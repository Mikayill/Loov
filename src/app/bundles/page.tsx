  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-7 sm:py-12">
      ...
      <div className="text-center mb-6 sm:mb-10">
        <span className="inline-block text-[10px] font-bold text-[#5E9E8C] uppercase tracking-widest bg-[#EAF2F0] px-3 py-1.5 rounded-full mb-2 sm:mb-3">
          {t("bundle.eyebrow")}
        </span>
        <h1 className="text-2xl sm:text-4xl font-extrabold text-[#2A2320] mb-2 sm:mb-3">
          {t("bundle.heroTitle")}
        </h1>
        <p className="text-[#5E5450] max-w-xl mx-auto text-[13px] sm:text-base leading-snug sm:leading-relaxed">
        ...
        {bundles.map((bundle) => {
          ...
          return (
            <Link
              ...
              className="group block bg-white rounded-2xl border border-[#DDD5CC] overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
            >
              ...
              >
                ...
                {bundle.isNew && (
                  <span className="absolute top-2 left-2 bg-[#5E9E8C] text-white text-[8px] sm:text-[9px] font-bold px-1.5 py-0.5 rounded-full uppercase tracking-wide">
                    {t("product.new")}
                  </span>
                )}
                {savings > 0 && (
                  <span className="absolute top-2 right-2 bg-[#2A2320] text-white text-[8px] sm:text-[9px] font-bold px-1.5 sm:px-2 py-0.5 rounded-full">
              ...
              <div className="p-2.5 sm:p-3">
                <h2 className="text-xs sm:text-sm font-extrabold text-[#2A2320] leading-snug line-clamp-1 group-hover:text-[#5E9E8C] transition-colors mb-1.5">
                  {bundle.name}
                </h2>
                ...
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="text-[10px] font-bold text-[#9A8E88] whitespace-nowrap">
                    {(() => {
                ...
                <p className="text-[10px] text-[#9A8E88] leading-snug line-clamp-1 mb-2">
                  {bundle.items
                ...
                <div className="flex items-baseline justify-between gap-1">
                  <span className="flex items-baseline gap-1.5 min-w-0">
                    <span className="text-sm sm:text-base font-extrabold text-[#2A2320]">
                      {formatPrice(bundle.bundlePrice)}
                    </span>
                    {bundle.originalPrice > bundle.bundlePrice && (
                      <span className="text-[10px] text-[#9A8E88] line-through">
                        {formatPrice(bundle.originalPrice)}
                      </span>
                    )}
                  </span>
                  {savingsPct > 0 && (
                    <span className="text-[9px] sm:text-[10px] font-bold text-[#5E9E8C] bg-[#EAF2F0] px-1.5 py-0.5 rounded-full flex-shrink-0">
                      −{savingsPct}%
                    </span>
                  )}
                </div>
      ...
      <div className="mt-10 sm:mt-16 text-center">
        <p className="text-[#9A8E88] text-sm mb-4">
          {t("bundle.lookingFor")}
        </p>
        <Link
          href="/products"
