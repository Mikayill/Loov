...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 z-[250] px-4 flex justify-center pointer-events-none">
      <div
        className="bg-[#2A2320] text-white rounded-2xl shadow-2xl px-5 py-4 max-w-lg w-full pointer-events-auto flex flex-col sm:flex-row items-start sm:items-center gap-4"
      >
        ...
        <div className="flex items-center gap-2 flex-shrink-0 self-end sm:self-auto">
          <button
            onClick={decline}
            className="text-xs font-semibold text-[#9A8E88] hover:text-white transition-colors px-3 py-1.5"
          >
            {t("cookie.decline")}
          </button>
          <button
